...
const config = {
  ...
  mongodb: {
    uri: process.env.MONGODB_URI || 'mongodb://hometrip:hometrip_mongo_pass@mongodb:27017/auth_db?authSource=admin'
  },
  ...
  email: {
    ...
    from: process.env.EMAIL_FROM || 'noreply@hometrip.com'
  },
  ...
  twoFactor: {
    ...
    issuer: process.env.TWO_FACTOR_ISSUER || 'HomeTrip'
  }
};
